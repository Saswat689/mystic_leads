...
const Signin = ({ providers, error }) => {
  ...
  function forgotPassword() {
    try {
      ...
      signIn("email", { callbackUrl: "/dashboard", email: data.email });
  ...
  return (
    <>
      {/* <!-- ===== SignIn Form Start ===== --> */}
      <section className="pb-12.5 pt-32.5 lg:pb-25 lg:pt-36">
        <div className="relative z-1 mx-auto max-w-c-1016 px-7.5 pb-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-20">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center md:gap-8">
              ...
              >
                <span className="mr-3">
                  <img src="/discord-icon.svg" className="w-[22px] h-[22px]" />
                </span>
                Signup with Discord
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-7.5 flex flex-col gap-7.5 lg:mb-12.5 lg:flex-row lg:justify-between lg:gap-14">
                <input
                  ...
                  className="w-full border-b border-stroke bg-transparent pb-3.5 focus:border-blue-500 focus:placeholder:text-blue-500 focus-visible:outline-none dark:border-strokedark dark:focus:border-manatee dark:focus:placeholder:text-white lg:w-1/2"
                />
              ...
              <div className="flex flex-wrap items-center gap-10 md:justify-between xl:gap-15">
                <div
                  className="flex flex-wrap gap-4 md:gap-10 cursor-pointer"
