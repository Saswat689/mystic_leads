      ...
      <section className="overflow-hidden pb-20 lg:pb-25 xl:pb-30">
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <div className="w-full bg-gradient-to-b from-blue-50 rounded-lg to-white h-full">
            ...
            >
              ...
              <p>
                Mystic Leads allows you to get high quality leads from credible
                sources like google or yelp and close them with our suite of AI
                tools
              </p>
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  ...
                  <p>Full performance reports and personalised AI emails</p>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section>
        <div className="mx-auto max-w-c-1235 overflow-hidden px-4 md:px-8 2xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <div className="w-full bg-gradient-to-b from-amber-50 rounded-lg to-white h-full">
                <div style={vidContainerChild}>
                  <video autoPlay loop muted style={video}>
