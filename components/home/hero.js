...
export default function HeroSection() {
  return (
    ...
    >
      ...
      >
        THE ONLY TOOL YOU NEED TO GET CLIENTS &
      </h1>
      <h2
        className={`mb-2 text-center ${mont.className} uppercase my-0 mb-8 font-[900] md:text-[2.3rem] text-2xl tracking-wide`}
      >
        GROW YOUR AGENCY IN 2024
      </h2>
      <p className="text-yellow-500 tracking-[0.5rem] py-0 font-bold my-0 mb-4 text-sm md:text-xl uppercase md:flex hidden items-center gap-x-4">
      ...
      <div className="grid grid-cols-1 py-0 mx-auto my-0 md:text-center text-sm md:text-lg lg:grid-cols-2 gap-y-1 lg:flex-row rounded-xl">
        <p className={`flex items-center gap-x-2 md:justify-center mb-0 pb-0`}>
        ...
        <p className="flex items-center md:justify-center gap-x-2 mb-0 pb-0">
          <CheckCircleOutlineIcon
            fontSize="large"
            className="text-yellow-500"
          />{" "}
